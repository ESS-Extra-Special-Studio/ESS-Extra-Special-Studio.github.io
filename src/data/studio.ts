export const studio = {
  ...
  about:
    "We ship Extra Special Minecraft mods from the Extra Special Studio GitHub organisation, and modpacks (Creatopia Unbound, C.ideas) on CurseForge. Extra Special Web (ESW) is software, not a Minecraft mod. We do not list store, Discord, or streaming links until they are real. Radio Towers is a companion to Dead Air, not an Extra Special Studio mod.",
